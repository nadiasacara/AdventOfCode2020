CLASS ltcl_day4 DEFINITION FINAL FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.
  ...
  PRIVATE SECTION.
    ...
    METHODS first_4_passes FOR TESTING RAISING cx_static_check.
    METHODS first_my_input FOR TESTING RAISING cx_static_check.

    METHODS second_invalid FOR TESTING RAISING cx_static_check.
    METHODS second_valid FOR TESTING RAISING cx_static_check.
...
CLASS ltcl_day4 IMPLEMENTATION.
  ...
  METHOD first_4_passes.
    ...
    cut = NEW zcl_day4_ns( input ).
    cl_abap_unit_assert=>assert_equals( exp = 2 act = cut->first( ) ).
  ...
  METHOD second_invalid.
    ...
    cut = NEW zcl_day4_ns( input ).
    cl_abap_unit_assert=>assert_equals( exp = 0 act = cut->second( ) ).
  ENDMETHOD.
  ...
  METHOD second_valid.
    ...
    cut = NEW zcl_day4_ns( input ).
    cl_abap_unit_assert=>assert_equals( exp = 4 act = cut->second( ) ).
  ENDMETHOD.
