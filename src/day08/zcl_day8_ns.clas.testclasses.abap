CLASS ltcl_day8 DEFINITION FINAL FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.
  ...
  PRIVATE SECTION.
    ...
    methods second_short for testing.
...
CLASS ltcl_day8 IMPLEMENTATION.
  ...
  METHOD first_short.
    ...
    cut = NEW zcl_day8_ns( input ).
    cl_abap_unit_assert=>assert_equals( exp = 5 act = cut->first( ) ).
  ENDMETHOD.
